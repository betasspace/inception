...
def _eval_once(saver, summary_writer, top_1_op, top_5_op, summary_op):
    ...
    with tf.Session() as sess:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            logging.info('Successfully loaded model from %s at step=%s.' %
                  (ckpt.model_checkpoint_path, global_step))
        else:
            logging.error('No checkpoint file found')
            return
        ...
        try:
            ...
            logging.info('starting evaluation on (%s).' % FLAGS.subset)
            ...
            while step < num_iter and not coord.should_stop():
                ...
                if step % 20 == 0:
                    ...
                    logging.info('[%d batches out of %d] (%.1f examples/sec; %.3f'
            ...
            logging.info('precision @ 1 = %.4f recall @ 5 = %.4f [%d examples]' %
